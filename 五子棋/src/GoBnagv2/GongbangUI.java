...
public class GongbangUI extends JFrame implements GoabngConfig {
    ...
    private final String[] butname={"开始游戏","重新开始","悔棋","存档","读档","录制棋局","停止录制","播放录制棋局","返回主菜单",};
    ...
    public  void initGoBangWindow(int firstcolor){
        //初始化创建UI界面
        this.setTitle("使我每天都很快乐的五子棋");
//        this.setLocation();
        this.setLocationRelativeTo(null);

        this.setSize(1200,1000);
        this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        gl.setFirstcolor(firstcolor);
        ...
        Dimension butPanelSize=new Dimension(150,70); // 设置放置按钮的Panel的大小
